...
@Component({
  selector: 'ted-pie-dougnut-chart',
  templateUrl: './pie-dougnut-chart.component.html',
  styleUrls: ['./pie-dougnut-chart.component.scss']
})
export class PieDougnutChartComponent implements OnInit {
